      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="space-y-32">
          ...
          >
            ...
            {/* Adăugăm 'order-2 md:order-1' -> pe mobil va fi al doilea element */}
            <div className="w-full md:w-1/2 p-8 md:p-12 z-20 order-2 md:order-1">
              ...
              {/* Butonul va fi acum la finalul coloanei de text */}
              <Link 
            ...
            {/* 2. IMAGE COLUMN */}
            {/* Adăugăm 'order-1 md:order-2' -> pe mobil va fi primul element sub titlu */}
